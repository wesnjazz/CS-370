...
im2 = imread('../data/umass_building_right5.jpg'); % right image (change this to right2, right3,..., right5)
% im1 = imread('../extra_credit/crack01.JPG');
% im2 = imread('../extra_credit/crack02.JPG');
