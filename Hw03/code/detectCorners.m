...
if isSimple
    figure(5)
    imagesc(cornerScore); colormap('parula'); colorbar;
else
    figure(9)
    imagesc(cornerScore); colormap('parula'); colorbar;
end
...
% cornerScore = 0.051*rand(size(I)); % Replace this with your implementation
...
%         cornerScore = cornerScore + imfilter(imdiff.^2, ones(3), 'same');
